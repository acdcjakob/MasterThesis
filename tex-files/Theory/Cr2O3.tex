...
% Miscellaneous
As coating material, \ce{Cr2O3} is commonly used due to its high hardness and resistance against corrosion \cite{singh2019,al-kuhaili2007}, also explaining its use-case as component of stainless steel to form passive films \cite{lebreau2014}.
...
Substituting \ce{Cr} atoms with less valent hole providers -- compared to structural defects of pure \ce{Cr2O3} -- does not only allow for a more controlled defect incorporation, but is also energetically more favorable due to a lower formation energy of \ce{Mg_{Cr}} compared to $V_{\ce{Cr}}$
    \cite{kehoe2016}.
\textcite{uekawa1996} report an increase in conductivity of five orders of magnitude for \ce{Cr2O3{:}Mg} thin films.
