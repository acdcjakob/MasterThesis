\acrfull{pld} is a \acrfull{pvd} technique, which utilizes absorption of laser energy by a target and subsequent condensation of evaporated target material on a substrate.
...
The crystal growth takes place on a substrate, and in this work, the substrate is chosen to be sapphire (\ce{Al2O3}) of different crystal orientation (\textit{c}-, \textit{r}-, \textit{m}- and \textit{a}-plane), because it matches the symmetry of the here investigated sesquioxides.
...
To gain more information about the real growth temperature, one should use a reference sample equipped with a \ce{Pt}-temperature sensor.
