...
\paragraph{\textit{r}-plane}
    ...
    \begin{equation}
        ...
        \end{pmatrix}\,,
    \end{equation}
    with $|\mathbf{q}_{(03.0)}|$ calculated from Equ.\,\ref{Equ:Methods_qAbs} and Equ.\,\ref{Equ:Methods_dhkl}.
    $\alpha_{(03.0)|r}$ denotes the angle between the (03.0) reflection and the normal of the \textit{r}-planes; it can be calculated from Equ.\,\ref{Equ:Methods_angleWRTc}:
    \begin{equation}
        \alpha_{(03.0)|r}
        = \qty{90}{\degree}-\left(
...
\paragraph{\textit{m}-plane}
    ...
    The tilt angle and shear angle can be calculated according to Equ.\,\ref{Equ:Results_3_tiltAngle} and Equ.\,\ref{Equ:Methods_shearAngle}, respectively.
