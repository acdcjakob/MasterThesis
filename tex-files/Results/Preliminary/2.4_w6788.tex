...
Several smaller peaks also correspond to those reflections but stem from other X-rays than \ce{Cu}-K\textalpha.
...
\begin{figure}
    \centering
    \includegraphics{1_W6788_2theta_labelled2.pdf}
    \caption{
...
In previous studies, activation energies of \qtyrange{400}{500}{\milli\eV} for polycrystalline \cro\ thin films prepared by \gls{cvd}
    \cite{cheng1996}
and \qty{200}{\milli\eV} for \ce{Mg}-doped \textit{c}-plane thin films prepared by electron beam \gls{pvd} evaporation
    \cite{farrell2015}
were reported.
