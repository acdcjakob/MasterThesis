...
The elements chosen for this are lower valent \ce{Cu} via \ce{CuO} and \ce{Zn^2+} via \ce{ZnO}, because doping has already been accomplished on \textit{c}-plane sapphire with magnesium via \ce{MgO}
    \cite{farrell2015}.
