...
But the correction of thin film tilt which is done for \glspl{RSM} was not done for the \thetaomega-scans\footnote{
    The \textomega-optimization prior to a \thetaomega-scan is for correcting a tilt of the whole sample, because $2\theta$ is fixed to the value expected for the (02.4) reflection of \ce{Al2O3}.
